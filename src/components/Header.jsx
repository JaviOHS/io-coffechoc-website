...
function Header({ header }) {
  ...
  return (
    <header id="header" className="relative overflow-hidden bg-gradient-to-br from-brown-900 via-amber-900 to-brown-800 pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <FloatingIcon
              ...
              animationClasses="rotate-12 animate-float"
            />
            <FloatingIcon
              icon={Cookie}
